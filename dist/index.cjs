...
var $dbSRa$react__default = /*#__PURE__*/_interopDefaultLegacy($dbSRa$react);
var $4AOtR$reactdom__default = /*#__PURE__*/_interopDefaultLegacy($4AOtR$reactdom);
...
var f=$dbSRa$react__default["default"],k=Symbol.for("react.element"),l=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,n=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};
...
function requireReactJsxRuntime_development () {
	...
	var React = $dbSRa$react__default["default"];
 ...
 */ 
const $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c = typeof document !== 'undefined' ? ($dbSRa$react__default["default"]).useLayoutEffect : ()=>{};
...
const $b5e257d569688ac6$var$SSRContext = /*#__PURE__*/ ($dbSRa$react__default["default"]).createContext($b5e257d569688ac6$var$defaultContext);
const $b5e257d569688ac6$var$IsSSRContext = /*#__PURE__*/ ($dbSRa$react__default["default"]).createContext(false);
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
    let id = ($dbSRa$react__default["default"]).useId();
    let [didSSR] = ($dbSRa$react.useState)($b5e257d569688ac6$export$535bd6ca7f90a273());
    let prefix = didSSR || process.env.NODE_ENV === 'test' ? 'react-aria' : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
    return defaultId || `${prefix}-${id}`;
}
const $b5e257d569688ac6$export$619500959fc48b26 = typeof ($dbSRa$react__default["default"])['useId'] === 'function' ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
    ...
    if (typeof ($dbSRa$react__default["default"])['useSyncExternalStore'] === 'function') return ($dbSRa$react__default["default"])['useSyncExternalStore']($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
...
function $bdb11010cef70236$export$f680877a34711e37(defaultId) {
    ...
    let cleanupRef = ($dbSRa$react.useRef)(null);
...
function $df56164dff5785e2$export$4338b53315abf666(ref) {
    ...
    const cleanupRef = ($dbSRa$react.useRef)(undefined);
    const refEffect = ($dbSRa$react.useCallback)((instance)=>{
...
function $d3f049242431219c$export$6d3443f2c48bfc20(ref, isReady = true) {
    ...
    $d3f049242431219c$var$useAnimation(ref, isAnimationReady, ($dbSRa$react.useCallback)(()=>setEntering(false), []));
    return isAnimationReady;
}
function $d3f049242431219c$export$45fda7c47f93fd48(ref, isOpen) {
    let [exitState, setExitState] = ($dbSRa$react.useState)(isOpen ? 'open' : 'closed');
    switch(exitState){
        case 'open':
    ...
    $d3f049242431219c$var$useAnimation(ref, isExiting, ($dbSRa$react.useCallback)(()=>{
    ...
    ($f0a04ccd8dbdd83b$export$e5c5a5f917a5871c)(()=>{
        if (isActive && ref.current) {
            ...
            Promise.all(animations.map((a)=>a.finished)).then(()=>{
                if (!canceled) ($4AOtR$reactdom.flushSync)(()=>{
                    onEnd();
                });
            }).catch(()=>{});
            return ()=>{
 ...
 * governing permissions and limitations under the License.
 */ 
const $ae1eeba8b9eafd08$export$5165eccb35aaadb5 = ($dbSRa$react__default["default"]).createContext({
    register: ()=>{}
});
    ...
    let pressProps = ($dbSRa$react.useMemo)(()=>{
        ...
        if (typeof PointerEvent !== 'undefined') {
            ...
            pressProps.onMouseDown = (e)=>{
                ...
                let shouldStopPropagation = ($4AOtR$reactdom.flushSync)(()=>triggerPressStart(e, state.pointerType));
                if (shouldStopPropagation) e.stopPropagation();
                if (preventFocusOnPress) {
                    let dispose = ($8a9cb279dc87e130$export$cabe61c495ee3649)(e.target);
                    if (dispose) state.disposables.push(dispose);
...
let $f645667febf57a63$export$f9762fab77588ecb = /*#__PURE__*/ ($dbSRa$react__default["default"]).createContext(null);
function $f645667febf57a63$var$useFocusableContext(ref) {
    let context = ($dbSRa$react.useContext)($f645667febf57a63$export$f9762fab77588ecb) || {};
...
function $f1ab8c75478c6f73$export$cf75428e0b9ed1ea({ children: children }) {
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($ae1eeba8b9eafd08$export$5165eccb35aaadb5).Provider, {
        value: context
    }, children);
}
...
const $18f2051aff69b9bf$var$I18nContext = /*#__PURE__*/ ($dbSRa$react__default["default"]).createContext(null);
...
const $9bf71ea28793e738$var$FocusContext = /*#__PURE__*/ ($dbSRa$react__default["default"]).createContext(null);
...
function $9bf71ea28793e738$export$20e40289641fbbb6(props) {
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($9bf71ea28793e738$var$FocusContext.Provider, {
        value: value
    }, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("span", {
        "data-focus-scope-start": true,
        hidden: true,
        ref: startRef
    }), children, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("span", {
...
function $9bf71ea28793e738$var$useAutoFocus(scopeRef, autoFocus) {
    const autoFocusRef = ($dbSRa$react__default["default"]).useRef(autoFocus);
    ($dbSRa$react.useEffect)(()=>{
...
function $9bf71ea28793e738$var$useRestoreFocus(scopeRef, restoreFocus, contain) {
    ...
    // eslint-disable-next-line no-restricted-globals
    const nodeToRestoreRef = ($dbSRa$react.useRef)(typeof document !== 'undefined' ? ($d4ee10de306f2510$export$cd4e5573fbe2b576)(($431fbd86ca7dc216$export$b204af158042fbac)(scopeRef.current ? scopeRef.current[0] : undefined)) : null);
...
function $36a0ac60f04457c5$export$136073280381448e(props, state, ref) {
    ...
    let touchDragTimerRef = ($dbSRa$react.useRef)(undefined);
    let { pressProps: pressProps, isPressed: isPressed } = ($f6c31cce2adf654f$export$45712eceda6fad21)({
...
function $e5be200c675c3b3a$var$useFormValidationStateImpl(props) {
    ...
    let clientError = ($dbSRa$react.useMemo)(()=>{
...
function $5c3e21d68f1c4674$export$439d29a4e110a164(props) {
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(Element, ($3ef42575df84b30b$export$9d1611c77c2fe928)(otherProps, visuallyHiddenProps), children);
}
...
function $2d73ec29415bd339$export$712718f7aec83d5(props, ref) {
    ...
    return {
        ...
        inputProps: ($3ef42575df84b30b$export$9d1611c77c2fe928)(domProps, inputElementType === 'input' ? inputOnlyProps : undefined, {
            ...
            [parseInt(($dbSRa$react__default["default"]).version, 10) >= 17 ? 'enterKeyHint' : 'enterkeyhint']: props.enterKeyHint,
            // Clipboard events
            onCopy: props.onCopy,
            onCut: props.onCut,
...
function $2a41e45df1593e64$export$d39e1813b3bdd0e1(props) {
    ...
    let [position, setPosition] = ($dbSRa$react.useState)(null);
    let deps = [
...
function $86ea4cb521eb2e37$export$2317d149ed6f78c4(props) {
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($5c3e21d68f1c4674$export$439d29a4e110a164), null, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("button", {
        ...labels,
        tabIndex: -1,
        onClick: onClick,
        style: {
...
const $337b884510726a0d$export$a2200b96afd16271 = /*#__PURE__*/ ($dbSRa$react__default["default"]).createContext(null);
function $337b884510726a0d$export$c6fdb837b070b4ff(props) {
    ...
    if (!props.disableFocusManagement) contents = /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($9bf71ea28793e738$export$20e40289641fbbb6), {
        restoreFocus: true,
        contain: (props.shouldContainFocus || contain) && !isExiting
    }, contents);
    contents = /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($337b884510726a0d$export$a2200b96afd16271.Provider, {
        value: contextValue
    }, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($f1ab8c75478c6f73$export$cf75428e0b9ed1ea), null, contents));
    return /*#__PURE__*/ ($4AOtR$reactdom__default["default"]).createPortal(contents, portalContainer);
}
...
function $32489daedd52963e$export$1315d136e6f7581(segment, state, ref) {
    ...
    return {
        segmentProps: ($3ef42575df84b30b$export$9d1611c77c2fe928)(spinButtonProps, labelProps, {
            ...
            [parseInt(($dbSRa$react__default["default"]).version, 10) >= 17 ? 'enterKeyHint' : 'enterkeyhint']: isEditable ? 'next' : undefined,
...
function $64fa3d84918910a7$export$2881499e37b75b9a({ values: values, children: children }) {
    ...
    children = /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(Context.Provider, {
        value: value
    }, children);
    return children;
}
...
function $64fa3d84918910a7$export$9d4c57ee4c6ffdd8(initialState = true) {
    ...
    let [hasSlot, setHasSlot] = ($dbSRa$react.useState)(initialState);
...
const $3985021b0ad6602f$export$f5b8910cec6cf069 = /*#__PURE__*/ ($f39a9eba43920ace$export$86427a43e3e48ebb)(function Input(props, ref) {
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("input", {
...
const $01b77f81d0f07f68$export$b04be29aa201d4f5 = /*#__PURE__*/ ($f39a9eba43920ace$export$86427a43e3e48ebb)(function Label(props, ref) {
    ...
    // @ts-ignore
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(ElementType, {
...
function $131cf43a05231e1e$export$6d095e787d2b5e1f(props) {
    ...
    let [lastCalendar, setLastCalendar] = ($dbSRa$react.useState)(calendar);
...
function $3c0fc76039f1c516$export$60e84778edff6d26(props) {
    ...
    let calendarValue = ($dbSRa$react.useMemo)(()=>{
        var _convertValue;
    ...
    let allSegments = ($dbSRa$react.useMemo)(()=>dateFormatter.formatToParts(new Date()).filter((seg)=>$3c0fc76039f1c516$var$EDITABLE_SEGMENTS[seg.type]).reduce((p, seg)=>(p[$3c0fc76039f1c516$var$TYPE_MAPPING[seg.type] || seg.type] = true, p), {}), [
        dateFormatter
    ]);
    let [validSegments, setValidSegments] = ($dbSRa$react.useState)(()=>props.value || props.defaultValue ? {
            ...allSegments
        } : {});
    let clearedSegment = ($dbSRa$react.useRef)(null);
    // Reset placeholder when calendar changes
    let lastCalendar = ($dbSRa$react.useRef)(calendar);
    ($dbSRa$react.useEffect)(()=>{
    ...
    let segments = ($dbSRa$react.useMemo)(()=>$3c0fc76039f1c516$var$processSegments(dateValue, validSegments, dateFormatter, resolvedOptions, displayValue, calendar, locale, granularity), [
        dateValue,
        validSegments,
        dateFormatter,
        resolvedOptions,
...
const $a049562f99e7db0e$export$eb2fcfdbd7ba97d4 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Group(props, ref) {
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("div", {
...
const $bcdf0525bf22703d$export$2c73285ae9390cec = /*#__PURE__*/ ($f39a9eba43920ace$export$86427a43e3e48ebb)(function TextField(props, ref) {
    ...
    }, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($64fa3d84918910a7$export$2881499e37b75b9a), {
        values: [
            [
...
const $dfd62f934fc76fed$export$3b805cea1f178355 = /*#__PURE__*/ ($dbSRa$react.createContext)(null);
const $dfd62f934fc76fed$export$233dd9682e1ad64b = /*#__PURE__*/ ($dbSRa$react.createContext)(null);
...
const $dfd62f934fc76fed$export$e1aef45b828286de = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Calendar(props, ref) {
    ...
    }, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($5c3e21d68f1c4674$export$439d29a4e110a164), null, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("h2", null, calendarProps['aria-label'])), renderProps.children, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($5c3e21d68f1c4674$export$439d29a4e110a164), null, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("button", {
...
const $dfd62f934fc76fed$export$5bd780d491cfc46c = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function CalendarGrid(props, ref) {
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($dfd62f934fc76fed$var$InternalCalendarGridContext.Provider, {
        value: {
    ...
    }, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("table", {
        ...($65484d02dcb7eb3e$export$457c3d6518dd4c6f)(props),
        ...gridProps,
        ref: ref,
        style: props.style,
        className: (_props_className = props.className) !== null && _props_className !== void 0 ? _props_className : 'react-aria-CalendarGrid'
    }, typeof props.children !== 'function' ? props.children : /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($dbSRa$react__default["default"]).Fragment, null, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($dfd62f934fc76fed$export$22e2d15eaa4d2377, null, (day)=>/*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($dfd62f934fc76fed$export$ad2135cac3a11b3d, null, day)), /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($dfd62f934fc76fed$export$e11f8ba65d857bff, null, props.children))));
});
function $dfd62f934fc76fed$var$CalendarGridHeader(props, ref) {
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("thead", {
        ...($65484d02dcb7eb3e$export$457c3d6518dd4c6f)(props),
        ...headerProps,
        ref: ref,
        style: style,
        className: className || 'react-aria-CalendarGridHeader'
    }, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("tr", null, weekDays.map((day, key)=>/*#__PURE__*/ ($dbSRa$react__default["default"]).cloneElement(children(day), {
            key: key
        }))));
}
/**
...
function $dfd62f934fc76fed$var$CalendarHeaderCell(props, ref) {
    let { children: children, style: style, className: className } = props;
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("th", {
        ...($65484d02dcb7eb3e$export$457c3d6518dd4c6f)(props),
        ref: ref,
        style: style,
...
function $dfd62f934fc76fed$var$CalendarGridBody(props, ref) {
    ...
    let rangeCalendarState = ($dbSRa$react.useContext)($dfd62f934fc76fed$export$5e0fc348c00f87a0);
    let state = calendarState !== null && calendarState !== void 0 ? calendarState : rangeCalendarState;
    let { startDate: startDate, weeksInMonth: weeksInMonth } = ($dbSRa$react.useContext)($dfd62f934fc76fed$var$InternalCalendarGridContext);
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("tbody", {
        ...($65484d02dcb7eb3e$export$457c3d6518dd4c6f)(props),
        ref: ref,
        style: style,
    ...
    ].map((weekIndex)=>/*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("tr", {
            key: weekIndex
        }, state.getDatesInWeek(weekIndex, startDate).map((date, i)=>date ? /*#__PURE__*/ ($dbSRa$react__default["default"]).cloneElement(children(date), {
                key: i
            }) : /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("td", {
                key: i
            })))));
}
/**
...
const $dfd62f934fc76fed$export$5d847498420df57b = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function CalendarCell({ date: date, ...otherProps }, ref) {
    let calendarState = ($dbSRa$react.useContext)($dfd62f934fc76fed$export$9e31dcedda1dadc7);
    let rangeCalendarState = ($dbSRa$react.useContext)($dfd62f934fc76fed$export$5e0fc348c00f87a0);
    let state = calendarState !== null && calendarState !== void 0 ? calendarState : rangeCalendarState;
    var _useContext;
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("td", {
        ...cellProps,
        ref: ref
    }, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("div", {
...
const $07b14b47974efb58$var$PopoverGroupContext = /*#__PURE__*/ ($dbSRa$react.createContext)(null);
const $07b14b47974efb58$export$5b6b19405a83ff9d = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Popover(props, ref) {
    ...
    if (isHidden) {
        ...
        return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($dbSRa$react__default["default"]).Fragment, null, children);
    }
    if (state && !state.isOpen && !isExiting) return null;
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($07b14b47974efb58$var$PopoverInner, {
        ...props,
...
function $07b14b47974efb58$var$PopoverInner({ state: state, isExiting: isExiting, UNSTABLE_portalContainer: UNSTABLE_portalContainer, clearContexts: clearContexts, ...props }) {
    ...
    let containerRef = ($dbSRa$react.useRef)(null);
    let groupCtx = ($dbSRa$react.useContext)($07b14b47974efb58$var$PopoverGroupContext);
    ...
    let [isDialog, setDialog] = ($dbSRa$react.useState)(false);
    ($f0a04ccd8dbdd83b$export$e5c5a5f917a5871c)(()=>{
    ...
    let children = ($dbSRa$react.useMemo)(()=>{
        let children = renderProps.children;
        if (clearContexts) for (let Context of clearContexts)children = /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(Context.Provider, {
            value: null
        }, children);
        return children;
    }, [
    ...
    let overlay = /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("div", {
    ...
    }, !props.isNonModal && /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($86ea4cb521eb2e37$export$2317d149ed6f78c4), {
        onDismiss: state.close
    }), /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($44f671af83e7d9e0$export$2de4954e8ae13b9f).Provider, {
        value: {
            ...arrowProps,
            placement: placement,
            ref: arrowRef
        }
    }, children), /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($86ea4cb521eb2e37$export$2317d149ed6f78c4), {
        onDismiss: state.close
    }));
    // If this is a root popover, render an extra div to act as the portal container for submenus/subdialogs.
    if (!isSubPopover) return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($337b884510726a0d$export$c6fdb837b070b4ff), {
        ...props,
        shouldContainFocus: isDialog,
        isExiting: isExiting,
        portalContainer: UNSTABLE_portalContainer
    }, !props.isNonModal && state.isOpen && /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("div", {
    ...
    }, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($07b14b47974efb58$var$PopoverGroupContext.Provider, {
        value: containerRef
    }, overlay)));
    var _ref;
    // Submenus/subdialogs are mounted into the root popover's container.
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($337b884510726a0d$export$c6fdb837b070b4ff), {
        ...props,
        shouldContainFocus: isDialog,
        isExiting: isExiting,
...
const $de32f1b87079253c$export$3ddf2d174ce01153 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Dialog(props, ref) {
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("section", {
        ...($65484d02dcb7eb3e$export$457c3d6518dd4c6f)(props),
        ...dialogProps,
        ...renderProps,
        ref: ref,
...
const $40825cdb76e74f70$export$7edc06cf1783b30f = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function DateInput(props, ref) {
    ...
    return dateFieldState || timeFieldState ? /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($40825cdb76e74f70$var$DateInputInner, {
        ...props,
        ref: ref
    }) : /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($40825cdb76e74f70$var$DateInputStandalone, {
        ...props,
        ref: ref
    });
});
const $40825cdb76e74f70$var$DateInputStandalone = /*#__PURE__*/ ($dbSRa$react.forwardRef)((props, ref)=>{
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($64fa3d84918910a7$export$2881499e37b75b9a), {
        values: [
            [
    ...
    }, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($40825cdb76e74f70$var$DateInputInner, props));
});
const $40825cdb76e74f70$var$DateInputInner = /*#__PURE__*/ ($dbSRa$react.forwardRef)((props, ref)=>{
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($dbSRa$react__default["default"]).Fragment, null, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($a049562f99e7db0e$export$eb2fcfdbd7ba97d4), {
        ...props,
        ref: ref,
        slot: props.slot || undefined,
        ...
        isDisabled: state.isDisabled
            ...
            key: i
        }))), /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($3985021b0ad6602f$export$f5b8910cec6cf069), null));
});
const $40825cdb76e74f70$export$336ab7fa954c4b5f = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function DateSegment({ segment: segment, ...otherProps }, ref) {
    let dateFieldState = ($dbSRa$react.useContext)($40825cdb76e74f70$export$3b08bebcf796eea0);
    let timeFieldState = ($dbSRa$react.useContext)($40825cdb76e74f70$export$5d8dc44abd10a920);
    let state = dateFieldState !== null && dateFieldState !== void 0 ? dateFieldState : timeFieldState;
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("span", {
...
const $06d5b8ec9ee5d538$export$5109c6dd95d8fb00 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function DatePicker(props, ref) {
...
const $5cb03073d3f54797$export$a8a3e93435678ff9 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Heading(props, ref) {
    ...
    let Element = `h${level}`;
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(Element, {
        ...domProps,
        ref: ref,
...
const $f3f84453ead64de5$export$2b77a92f1a5ad772 = /*#__PURE__*/ ($dbSRa$react.forwardRef)(function Modal(props, ref) {
    let ctx = ($dbSRa$react.useContext)($f3f84453ead64de5$var$InternalModalContext);
    if (ctx) return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($f3f84453ead64de5$var$ModalContent, {
        ...props,
        modalRef: ref
    }, props.children);
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($f3f84453ead64de5$export$8948f78d83984c69, {
        ...
        shouldCloseOnInteractOutside: shouldCloseOnInteractOutside
    }, /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($f3f84453ead64de5$var$ModalContent, {
        ...otherProps,
        modalRef: ref
    }, children));
});
function $f3f84453ead64de5$var$ModalOverlayWithForwardRef(props, ref) {
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement($f3f84453ead64de5$var$ModalOverlayInner, {
        ...props,
        state: state,
        isExiting: isExiting,
...
function $f3f84453ead64de5$var$ModalContent(props) {
    ...
    return /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement("div", {
        ...
        "data-entering": entering || undefined,
        "data-exiting": isExiting || undefined
    }, isDismissable && /*#__PURE__*/ ($dbSRa$react__default["default"]).createElement(($86ea4cb521eb2e37$export$2317d149ed6f78c4), {
        onDismiss: state.close
    }), renderProps.children);
}
